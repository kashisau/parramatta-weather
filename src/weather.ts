 ...
 * @returns {JSON}
 */
export default async function GetWeather({ WW_API_KEY }: EnvVars) {
    ...
    const forecastUrl = `https://api.willyweather.com.au/v2/${WW_API_KEY}/locations/4659/weather.json?forecasts=weather&days=5&startDate=${currentDateString}`
